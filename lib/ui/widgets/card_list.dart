            ...
            !snapshot.hasData
                ...
                : SizedBox(
                    ...
                    child: Swiper(
                      ...
                      //tamaño de list cardresult
                      itemCount: snapshot.data.length,
                      //dimension de cada tarjeta
                      itemWidth: _screenSize.width * 0.7,
                      itemHeight: _screenSize.height * 0.58,
                      //tipo de swiper - montadas entre tarjetas
...
class CardFrontList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    //Digitos debajo del numero de tarjeta (4 ultimos digitos)
  ...
  Widget _buildDots() {
    ...
    //agrega los 4 ultimos numeros de la tarjeta
